cpdefine("inline:com-chilipeppr-widget-tinyg", ["chilipeppr_ready", "jquerycookie"], function () {
    return {
        ...
        url: "http://fiddle.jshell.net/baimar97/bgzr98x0/show/light/",
        fiddleurl: "http://jsfiddle.net/baimar97/bgzr98x0/",
        name: "Tinyg v2.0",
        ...
        init: function () {
            ...
            chilipeppr.subscribe("/com-chilipeppr-widget-serialport/onportopen", this, function (msg) {
                console.log("got onportopen so will init controller");
                this.initController(true);
            });
        ...
        popupConfigDialog: function () {
            ...
            if (this.configtinyg != null) {
                ...
                // a hidden DIV).
                var that = this;
                chilipeppr.load("#com-chilipeppr-widget-tinyg-holderAreaForConfigWidget", 'http://fiddle.jshell.net/khauser/vc1vd3n5/show/light', function () {
        ...
        processMotorTimeout: function (mt) {
            chilipeppr.publish("/com-chilipeppr-interface-cnccontroller/portinitialized","");
