...
requirejs.config({
    ...
    paths: {
        ...
        jqueryuiResizeable: 'lib/jquery.ui.resizable',
    },
    shim: {
...
cpdefine("inline:com-chilipeppr-widget-spconsole", ["chilipeppr_ready", "jquerycookie", 'jqueryuiResizeable'], function() {
    return {
        ...
        url: "http://fiddle.jshell.net/baimar97/9q68mxm0/show/light/",
        fiddleurl: "http://http://jsfiddle.net/baimar97/9q68mxm0/",
        name: "Serial Port Console v1.7",
        ...
        init: function(isSinglePortMode, filterRegExp) {
            ...
            if (!$("link[href='css/lib/jquery/jquery-ui.css']").length)
                $('<link>')
                .appendTo('head')
                .attr({
                    type: 'text/css',
                ...
                .attr('href', 'css/lib/jquery/jquery-ui.css');
